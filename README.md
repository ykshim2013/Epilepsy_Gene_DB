...
| Gene | ClinVar P/LP | Total ClinVar | Key Phenotype |
|------|--------------|---------------|---------------|
| SCN2A | 798 | 2,978 | DEE11, BFNIS |
| EEF1A2 | 114 | 728 | DEE33 |
| KCNQ2 | 953 | 2,493 | BFNS, KCNQ2-DEE |
| SYNGAP1 | 452 | 1,833 | MRD5, SYNGAP1-DEE |
| CDKL5 | 1,069 | 2,407 | CDD, DEE2 |
...
| Gene | First-Line ASM | Notes |
|------|----------------|-------|
| **SCN2A** | Na+ channel blockers (if onset <3mo) | GOF vs LOF determines treatment |
| **EEF1A2** | Variable | Generally drug-resistant |
| **KCNQ2** | Carbamazepine, Phenytoin | ~80% respond to Na+ blockers |
| **SYNGAP1** | Valproate, Lamotrigine | CBD promising |
